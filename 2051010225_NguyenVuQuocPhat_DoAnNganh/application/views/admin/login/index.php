...
<html>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form name="frm" method="post" action="">
			...
			<div class="row">
				<div class="col-xs-8">
					Hotline: <b class="c-red">0895 883 809</b><br />
					Website: <b class="c-red"><a href="http://www.sieuvietsoft.com" target="_blank">www.sieuvietsoft.com</a></b><br />
				</div>
				<div class="col-xs-4">
	...
	<nav class="navbar navbar-fixed-bottom" role="navigation">
		<div class="container">
		   <h5 class="text-center">Copyright © 2022 SVSoft. All rights reserved.</h5>
		</div>
	</nav>
